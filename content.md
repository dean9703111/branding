...
description = "外商資安公司軟體專家、生成式 AI 創新學院發起人、全台第一本 ChatGPT 應用專書作者。超過百場企業內訓與校園講座經驗。"
```

# Hero

```toml
eyebrow = "生成式 AI 講師・作家・軟體專家"
name    = "林鼎淵"
name_en = "DEAN LIN"
titles  = [
  "外商資安公司軟體專家",
...
lead  = "十五年軟體開發資歷，從工程師、專案經理到技術主管；如今把技術寫成書、講成課，陪伴企業與校園把 AI 真正用起來。"
...
- 外商軟體工程師：超過 15 年開發經驗，歷任工程師、專案經理、技術主管，具備跨部門、跨團隊的溝通與資訊整合能力。
- 暢銷書作家：出版 7 本技術與職涯類專書，包括《ChatGPT 與 AI 繪圖效率大師》、《工程師下班有約》、《給全端工程師的職涯筆記》等。
- 企業內訓講師：授課涵蓋生成式 AI 應用、程式開發、數位轉型，協助不同產業快速導入 AI 工具提升生產力。
- 部落客／專欄作家：撰寫 400+ 篇文章、累積超過 450 萬瀏覽，長期分享最新技術、團隊合作與工程師職涯。
- YouTube 創作者：經營頻道《工程師下班有約》，內容結合程式開發、AI 教學與生涯規劃。
...
cta       = "透過 Facebook 洽詢 →"
copyright = "© 2026 Dean Lin 林鼎淵・生成式 AI 講師・暢銷書作家・軟體專家"
```
